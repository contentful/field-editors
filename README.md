...
This is a fork that is used only for the contentful-extended-references Contentful extension. 
It allows React children to be passed to MultipleEntryReferenceEditor.
