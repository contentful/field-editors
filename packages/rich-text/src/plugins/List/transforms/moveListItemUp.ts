...
import { ELEMENT_LI, hasListChild, moveListItemsToList } from '@udecode/plate-list';
 ...
 * Move a list item up.
 */
export const moveListItemUp = (editor: PlateEditor, { list, listItem }: MoveListItemUpOptions) => {
  const move = () => {
