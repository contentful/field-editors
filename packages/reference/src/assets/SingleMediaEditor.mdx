...
import { Card, Asset } from '@contentful/forma-36-react-components';
import { TextLink, Button, Heading } from '@contentful/f36-components';
          ...
          renderCustomCard={(props) => {
            ...
            return (
              <Card testId="custom-card">
                  ...
                  <Asset src={file && file['en-US'].url} title={file && file['en-US'].fileName} />
