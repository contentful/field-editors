import { Canvas, Meta, Markdown, Story, Controls, Source } from '@storybook/addon-docs/blocks';
import * as EditorStories from './MultipleEntryReferenceEditor.stories';

import Readme from '../../README.md?raw';

<Markdown>{Readme}</Markdown>
<Source code={"import { MultipleEntryReferenceEditor } from '@contentful/field-editor-reference';"} />
...
Click **Link existing entries** to insert some references with custom layout rendered via **renderCustomCard** prop. Click again to showcase inserting
